...
angular.module('loomioApp').factory('HasDrafts', function($timeout, AppConfig) {
  var HasDrafts;
  return new (HasDrafts = (function() {
    ...
    HasDrafts.prototype.apply = function(model) {
      ...
      model.fetchAndRestoreDraft = function() {
        if (model.draftParent()) {
          return model.fetchDraft().then(model.restoreDraft);
        }
      };
      ...
      model.cancelDraftFetch = function() {
        if (model.draftFetch) {
          return $timeout.cancel(model.draftFetch);
        }
      };
      return model.planDraftFetch = function() {
        model.cancelDraftFetch();
        return model.draftFetch = $timeout(model.updateDraft, AppConfig.drafts.debounce);
      };
    };
...
angular.module('loomioApp').factory('FormService', function($rootScope, $translate, $window, FlashService, AbilityService) {
  var FormService;
  return new (FormService = (function() {
    ...
    success = function(scope, model, options) {
      return function(response) {
        ...
        if (typeof model.cancelDraftFetch === 'function') {
          model.cancelDraftFetch();
        }
    ...
    FormService.prototype.submit = function(scope, model, options) {
      ...
      if (options.drafts && model.isNew() && AbilityService.isLoggedIn()) {
...
angular.module('loomioApp').directive('descriptionCard', function(Records, ModalService, FormService, AbilityService, GroupModal, DocumentModal) {
  return {
    scope: {
      group: '='
    },
