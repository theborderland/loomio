angular.module('loomioApp').directive 'contextPanel', ($rootScope, $window, $timeout, Records, AbilityService, Session, ReactionService, ModalService, DocumentModal, ChangeVolumeForm, DiscussionModal, ThreadService, MoveThreadForm, PrintModal, DeleteThreadForm, RevisionHistoryModal, TranslationService, ScrollService) ->
  scope: {discussion: '='}
  restrict: 'E'
  replace: true
